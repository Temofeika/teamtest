...
const char* uniLinksPrefix = "teamdesk://";
                      ...
                      _In_ wchar_t *command_line, _In_ int show_command)
{
  ...
  // Uri links dispatch
  HWND hwnd = ::FindWindow(_T("FLUTTER_RUNNER_WIN32_WINDOW"), _T("TeamDesk"));
  if (hwnd != NULL) {
  ...
  if (!window.CreateAndShow(
          is_cm_page ? L"TeamDesk - Connection Manager" : L"TeamDesk", origin,
          size, !is_cm_page)) {
      return EXIT_FAILURE;
  }
