...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "В некоторых случаях из-за UAC TeamDesk может работать неправильно на удалённом узле. Чтобы избежать UAC, нажмите кнопку ниже для установки TeamDesk в системе."),
        ...
        ("Turned off", "Отключён"),
        ("Language", "Язык"),
        ("Keep RustDesk background service", "Держать в фоне службу TeamDesk"),
        ...
        ("Show RustDesk", "Показать TeamDesk"),
        ...
        ("install_cert_tip", "Установить сертификат TeamDesk"),
        ("confirm_install_cert_tip", "Это тестовый сертификат TeamDesk, которому можно доверять. Он будет использоваться только по необходимости для установки драйверов TeamDesk."),
        ...
        ("verify_rustdesk_password_tip", "Подтвердить пароль TeamDesk"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Обновите TeamDesk Server Pro до версии {} или новее!"),
        ...
        ("selinux_tip", "На вашем устройстве включён SELinux, что может помешать правильной работе TeamDesk на контролируемой стороне."),
        ("Change view", "Вид"),
