...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("TeamtDesk".to_owned()));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["teamdesk.bellini-gr.ru"];
pub const PUBLIC_RS_PUB_KEY: &str = "BEZEK+MjKDc6QtnSjwBvs5EsRp8bhTl61mrKemsdGMw=";
